...
public class DiaryListAdapter extends RecyclerView.Adapter<DiaryListAdapter.DiaryListViewHolder> {
  ...
  class DiaryListViewHolder extends RecyclerView.ViewHolder {
    ...
    DiaryListViewHolder(View itemView) {
      ...
      titleDate = (TextView) itemView.findViewById(R.id.diary_title_date);
  ...
  public void onBindViewHolder(DiaryListViewHolder diaryListViewHolder, int position) {
    ...
    diaryListViewHolder.titleDate.setText(d.getDayCNData());
    diaryListViewHolder.title.setText(d.getTitle());
    diaryListViewHolder.year.setText(d.getYearCN());
    diaryListViewHolder.content.setOnClickListener(new View.OnClickListener() {
      @Override
    ...
    diaryListViewHolder.content.setOnLongClickListener(new View.OnLongClickListener() {
      @Override
